...
public class OrderList extends AppCompatActivity {
    ...
    private void showAlertDialog(final int index) {
        ...
        final DatePickerDialog datePickerDialog = new DatePickerDialog(OrderList.this,
                new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, final int year,
                        ...
                        TimePickerDialog timePickerDialog = new TimePickerDialog(OrderList.this,
                                        ...
                                        builder.setTitle("Pilih Jenis Kelamin Therapist")
                                                .setItems(R.array.gender_array, new DialogInterface.OnClickListener() {
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        AlertDialog.Builder konfirm = new AlertDialog.Builder(OrderList.this);
                                                        ...
                                                        card_adapter = new CardAdapter(cart,OrderList.this);
                                                        ...
                                                        konfirm.setView(dialogView)
                                                                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        Toast.makeText(OrderList.this,"Pesanan berhasil diubuah",Toast.LENGTH_SHORT).show();
                                                                        finish();
                                                                    }
                                                                })
        ...
        if(item.getTitle().equals("Update")){
            ...
            alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Toast.makeText(OrderList.this,"Menu Pijat Berhasil Dihapus ",Toast.LENGTH_SHORT).show();
                }
            });
